...
public:
    ...
    UTL_ATTRIBUTES(NODISCARD, CONST) friend constexpr bool operator==(strong_ordering l, zero_t) noexcept {
        return l.value == 0;
    }
...
#if UTL_CXX20
    UTL_ATTRIBUTES(NODISCARD, CONST) friend constexpr strong_ordering operator<=>(
