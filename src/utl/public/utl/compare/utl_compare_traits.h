...
template <typename T, typename U>
struct is_less_equal_comparable<T, U,
    enable_if_t<is_boolean_testable<decltype(declval<T>() <= declval<U>())>::value>> : true_type {};
...
template <typename T, typename U>
struct is_greater_equal_comparable<T, U,
    enable_if_t<is_boolean_testable<decltype(declval<T>() >= declval<U>())>::value>> : true_type {};
...
template <typename T, typename U = T,
    typename R = decltype(details::compare_traits::nothrow_equality_test<T, U>(0))>
struct is_nothrow_equality_comparable : R {};

template <typename T, typename U = T,
    typename R = decltype(details::compare_traits::nothrow_nonequality_test<T, U>(0))>
struct is_nothrow_nonequality_comparable : R {};

template <typename T, typename U = T,
    typename R = decltype(details::compare_traits::nothrow_less_test<T, U>(0))>
struct is_nothrow_less_comparable : R {};

template <typename T, typename U = T,
    typename R = decltype(details::compare_traits::nothrow_greater_test<T, U>(0))>
struct is_nothrow_greater_comparable : R {};

template <typename T, typename U = T,
    typename R = decltype(details::compare_traits::nothrow_less_equal_test<T, U>(0))>
...
auto three_way_comparable_with_test(int)
    -> is_convertible<decltype(declval<T>() <=> declval<U>()), Cat>;

template <typename T, typename U, typename Cat>
auto nothrow_three_way_comparable_with_test(...) -> false_type;

template <typename T, typename U, typename Cat>
auto nothrow_three_way_comparable_with_test(int)
    -> bool_constant<decltype(three_way_comparable_with_test<T, U, Cat>(0))::value &&
...
struct is_three_way_comparable_with :
    decltype(details::compare_traits::three_way_comparable_with_test<T, U, Cat>(0)) {};
