...
template <typename T>
struct UTL_PUBLIC_TEMPLATE min_impl<T, true, true> {
...
template <typename T>
struct UTL_PUBLIC_TEMPLATE min_impl<T, true, false> {
...
template <typename T>
struct UTL_PUBLIC_TEMPLATE max_impl<T, true, true> {
...
template <typename T>
struct UTL_PUBLIC_TEMPLATE max_impl<T, true, false> {
...
struct UTL_PUBLIC_TEMPLATE max_impl<bool, A, B> {
    static constexpr bool value = true;
};
template <bool A, bool B>
constexpr bool max_impl<bool, A, B>::value;
template <bool A, bool B>
struct UTL_PUBLIC_TEMPLATE min_impl<bool, A, B> {
...
template <bool A, bool B>
struct UTL_PUBLIC_TEMPLATE max_impl<float16, A, B> {
    static constexpr float16 value = 6.5504e+4f16;
};
template <bool A, bool B>
constexpr float16 max_impl<float16, A, B>::value;
template <bool A, bool B>
struct UTL_PUBLIC_TEMPLATE min_impl<float16, A, B> {
...
template <bool A, bool B>
struct UTL_PUBLIC_TEMPLATE max_impl<float32, A, B> {
    static constexpr float32 value = 3.40282347e+38f32;
};
template <bool A, bool B>
constexpr float32 max_impl<float32, A, B>::value;
template <bool A, bool B>
struct UTL_PUBLIC_TEMPLATE min_impl<float32, A, B> {
...
template <bool A, bool B>
struct UTL_PUBLIC_TEMPLATE max_impl<float128, A, B> {
...
template <bool A, bool B>
struct UTL_PUBLIC_TEMPLATE min_impl<float128, A, B> {
...
template <bool A, bool B>
struct UTL_PUBLIC_TEMPLATE max_impl<bfloat16, A, B> {
    static constexpr bfloat16 value = 3.38953139e+38bf16;
};
template <bool A, bool B>
constexpr bfloat16 max_impl<bfloat16, A, B>::value;
template <bool A, bool B>
struct UTL_PUBLIC_TEMPLATE min_impl<bfloat16, A, B> {
...
struct fp_lowest;
template <typename T>
struct UTL_PUBLIC_TEMPLATE fp_lowest<T, true> {
...
template <typename T>
struct UTL_PUBLIC_TEMPLATE maximum : details::max_impl<remove_cv_t<T>> {};
template <typename T>
struct UTL_PUBLIC_TEMPLATE minimum : details::min_impl<remove_cv_t<T>> {};
template <typename T>
struct UTL_PUBLIC_TEMPLATE lowest : details::min_impl<T> {};
template <typename T>
struct UTL_PUBLIC_TEMPLATE lowest<T const> : lowest<T> {};
template <typename T>
struct UTL_PUBLIC_TEMPLATE lowest<T volatile> : lowest<T> {};
template <typename T>
struct UTL_PUBLIC_TEMPLATE lowest<T const volatile> : lowest<T> {};
template <>
struct UTL_PUBLIC_TEMPLATE lowest<float> : details::fp_lowest<float> {};
template <>
struct UTL_PUBLIC_TEMPLATE lowest<double> : details::fp_lowest<double> {};
template <>
struct UTL_PUBLIC_TEMPLATE lowest<long double> : details::fp_lowest<long double> {};
#if UTL_SUPPORTS_FLOAT16
template <>
struct UTL_PUBLIC_TEMPLATE lowest<float16> : details::fp_lowest<float16> {};
#endif
#if UTL_SUPPORTS_FLOAT32
template <>
struct UTL_PUBLIC_TEMPLATE lowest<float32> : details::fp_lowest<float32> {};
#endif
#if UTL_SUPPORTS_FLOAT64
template <>
struct UTL_PUBLIC_TEMPLATE lowest<float64> : details::fp_lowest<float64> {};
#endif
#if UTL_SUPPORTS_FLOAT128
template <>
struct UTL_PUBLIC_TEMPLATE lowest<float128> : details::fp_lowest<float128> {};
#endif
#if UTL_SUPPORTS_BFLOAT16
template <>
struct UTL_PUBLIC_TEMPLATE lowest<bfloat16> : details::fp_lowest<bfloat16> {};
#endif
#if UTL_CXX14
template <typename T>
