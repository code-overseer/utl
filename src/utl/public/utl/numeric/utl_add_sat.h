...
UTL_HIDE_FROM_ABI constexpr T impl(T left, T right) noexcept {
...
namespace runtime {
template <typename T>
UTL_HIDE_FROM_ABI auto has_overload_impl(float) noexcept -> UTL_SCOPE false_type;
template <typename T>
...
UTL_HIDE_FROM_ABI T impl(T left, T right) noexcept {
...
template <typename T>
UTL_HIDE_FROM_ABI constexpr T saturate(T result, T left) noexcept {
...
UTL_ATTRIBUTES(NODISCARD, CONST, HIDE_FROM_ABI, FLATTEN) constexpr T add_sat(T left, T right) noexcept {
