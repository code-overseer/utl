...
concept legacy_bidirectional_iterator = UTL_SCOPE legacy_forward_iterator<It> &&
    UTL_SCOPE bidirectional_iterator<It> && requires(It it) {
        { *it } -> UTL_SCOPE lvalue_reference;
    };

template <typename It>
struct is_legacy_bidirectional_iterator :
    UTL_SCOPE bool_constant<legacy_bidirectional_iterator<It>> {};

template <typename It>
inline constexpr bool is_legacy_bidirectional_iterator_v =
    UTL_SCOPE legacy_bidirectional_iterator<It>;
...
template <typename It>
auto check(int) -> UTL_SCOPE conjunction<UTL_SCOPE is_legacy_forward_iterator<It>,
...
template <typename It>
using implemented = decltype(UTL_SCOPE details::legacy_bidirectional_iterator::check<It>(0));
...
template <typename It>
struct is_legacy_bidirectional_iterator :
    UTL_SCOPE details::legacy_bidirectional_iterator::implemented<It> {};
