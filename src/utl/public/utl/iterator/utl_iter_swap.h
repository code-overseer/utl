...
UTL_HIDE_FROM_ABI UTL_CONSTEXPR_CXX14 UTL_SCOPE iter_value_t<L> iter_exchange(L&& l, R&& r) {
...
UTL_HIDE_FROM_ABI void default_impl(L&& l, R&& r) noexcept(nothrow_dereference_swappable<L, R>) {
    UTL_SCOPE ranges::swap(*l, *r);
}

template <typename L, typename R>
requires (!dereference_swappable<L, R> && exchange_swappable<L, R>)
UTL_HIDE_FROM_ABI void default_impl(L&& l, R&& r) noexcept(nothrow_exchange_swappable<L, R>) {
...
UTL_HIDE_FROM_ABI constexpr void iter_swap(L&& l, R&& r) noexcept(nothrow_defaultable<L, R>) {
...
struct function_t {
    ...
    UTL_HIDE_FROM_ABI constexpr void operator()(L&& l, R&& r) const
...
namespace iterator_swap {
template <typename L, typename R>
UTL_HIDE_FROM_ABI auto exchange_swappable(float) noexcept -> UTL_SCOPE false_type;
template <typename L, typename R>
UTL_HIDE_FROM_ABI auto exchange_swappable(int) noexcept
...
template <typename L, typename R>
UTL_HIDE_FROM_ABI auto nothrow_exchange_swappable(float) noexcept -> UTL_SCOPE false_type;
template <typename L, typename R>
UTL_HIDE_FROM_ABI auto nothrow_exchange_swappable(int) noexcept
...
template <typename L, typename R>
UTL_HIDE_FROM_ABI auto dereference_swappable(float) noexcept -> UTL_SCOPE false_type;
template <typename L, typename R>
UTL_HIDE_FROM_ABI auto dereference_swappable(int) noexcept -> UTL_SCOPE
...
template <typename L, typename R>
UTL_HIDE_FROM_ABI auto nothrow_dereference_swappable(float) noexcept -> UTL_SCOPE false_type;
template <typename L, typename R>
UTL_HIDE_FROM_ABI auto nothrow_dereference_swappable(int) noexcept
...
template <typename L, typename R>
UTL_HIDE_FROM_ABI UTL_SCOPE enable_if_t<is_dereference_swappable<L, R>::value> default_impl(
    L&& l, R&& r, unsigned int) noexcept(is_nothrow_dereference_swappable<L, R>::value) {
    UTL_SCOPE ranges::swap(*l, *r);
}

template <typename L, typename R>
UTL_HIDE_FROM_ABI UTL_SCOPE enable_if_t<is_exchange_swappable<L, R>::value> default_impl(
    L&& l, R&& r, unsigned short) noexcept(is_nothrow_exchange_swappable<L, R>::value) {
    *r = iter_exchange(UTL_SCOPE forward<L>(l), UTL_SCOPE forward<R>(r));
}

template <typename L, typename R>
UTL_HIDE_FROM_ABI int default_impl(L&&, R&&, ...) noexcept;
...
template <typename L, typename R>
UTL_HIDE_FROM_ABI constexpr UTL_SCOPE enable_if_t<is_defaultable<L, R>::value> iter_swap(
...
template <typename L, typename R>
UTL_HIDE_FROM_ABI auto nothrow_iter_swap(float) noexcept -> UTL_SCOPE false_type;

template <typename L, typename R>
UTL_HIDE_FROM_ABI auto nothrow_iter_swap(int) noexcept
...
struct function_t {
    template <typename L, typename R>
    UTL_HIDE_FROM_ABI constexpr iter_swappable<L, R> operator()(L&& l, R&& r) const
