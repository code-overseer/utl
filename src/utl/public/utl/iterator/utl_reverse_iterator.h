...
public:
    ...
    UTL_ATTRIBUTE(NODISCARD) UTL_HIDE_FROM_ABI constexpr auto operator[](offset_t idx) const noexcept(
    ...
    UTL_ATTRIBUTE(NODISCARD) UTL_HIDE_FROM_ABI constexpr reference operator*() const
        noexcept(noexcept(*UTL_SCOPE prev(this->current))) {
        return *UTL_SCOPE prev(this->current);
    }

    UTL_ATTRIBUTE(NODISCARD) UTL_HIDE_FROM_ABI constexpr pointer operator->() const
    ...
    UTL_HIDE_FROM_ABI UTL_CONSTEXPR_CXX14 reverse_iterator& operator++() noexcept(noexcept(--this->current)) {
        return --this->current, *this;
    }

    UTL_HIDE_FROM_ABI UTL_CONSTEXPR_CXX14 reverse_iterator operator++(int) noexcept(
    ...
    UTL_ATTRIBUTE(NODISCARD) UTL_HIDE_FROM_ABI constexpr reverse_iterator operator+(difference_type n) const
        noexcept(noexcept(UTL_SCOPE prev(this->current))) {
    ...
    UTL_HIDE_FROM_ABI UTL_CONSTEXPR_CXX14 reverse_iterator& operator+=(difference_type n) noexcept(
    ...
    UTL_HIDE_FROM_ABI friend constexpr UTL_SCOPE iter_rvalue_reference_t<iterator_type>
    ...
    UTL_HIDE_FROM_ABI friend constexpr void
    ...
    UTL_ATTRIBUTES(NODISCARD, PURE) UTL_HIDE_FROM_ABI constexpr iterator_type base() const noexcept {
        return current;
    }
...
UTL_HIDE_FROM_ABI constexpr UTL_SCOPE reverse_iterator<It> make_reverse_iterator(It it) noexcept(
...
template <typename It>
UTL_ATTRIBUTE(NODISCARD) UTL_HIDE_FROM_ABI constexpr reverse_iterator<It> operator+(
...
UTL_ATTRIBUTE(NODISCARD) UTL_HIDE_FROM_ABI constexpr auto
