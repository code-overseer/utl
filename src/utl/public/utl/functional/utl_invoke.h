...
UTL_ATTRIBUTES(HIDE_FROM_ABI, ALWAYS_INLINE) inline constexpr invoke_result_t<F, Args> invoke(
...
struct invoke_t {
    template <typename F, typename... Args>
    UTL_ATTRIBUTES(HIDE_FROM_ABI, ALWAYS_INLINE) static inline constexpr R call(F&& f, Args&&... args) noexcept(
...
struct invoke_t<void> {
    template <typename F, typename... Args>
    UTL_ATTRIBUTES(HIDE_FROM_ABI, ALWAYS_INLINE) static inline constexpr void call(
...
UTL_ATTRIBUTES(HIDE_FROM_ABI, ALWAYS_INLINE) inline constexpr R invoke_r(F&& f, Args&&... args) noexcept(
    UTL_TRAIT_is_nothrow_invocable_r(R, F, Args...)) {
