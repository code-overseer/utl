...
UTL_LIBC_PURE UTL_HIDE_FROM_ABI constexpr int memcmp(
...
UTL_LIBC_PURE UTL_HIDE_FROM_ABI constexpr T* memchr(T const* str, U value, size_t bytes) noexcept {
...
UTL_LIBC_PURE UTL_HIDE_FROM_ABI constexpr size_t strlen(T const* str) noexcept {
    return UTL_CONSTANT_P(str) ? compile_time::strlen(str) : runtime::strlen(str);
}

template <UTL_CONCEPT_CXX20(string_char) T UTL_REQUIRES_CXX11(is_string_char<T>::value)>
UTL_LIBC_PURE UTL_HIDE_FROM_ABI constexpr T* strchr(T const* str, T const ch) noexcept {
    return UTL_CONSTANT_P((ch, str)) ? compile_time::strchr(str, ch) : runtime::strchr(str, ch);
}

template <UTL_CONCEPT_CXX20(string_char) T UTL_REQUIRES_CXX11(is_string_char<T>::value)>
UTL_LIBC_PURE UTL_HIDE_FROM_ABI constexpr int strcmp(T const* left, T const* right) noexcept {
    return UTL_CONSTANT_P(left != right) ? compile_time::strcmp(left, right)
                                         : runtime::strcmp(left, right);
}

template <UTL_CONCEPT_CXX20(string_char) T UTL_REQUIRES_CXX11(is_string_char<T>::value)>
UTL_LIBC_PURE UTL_HIDE_FROM_ABI constexpr int strncmp(
...
template <UTL_CONCEPT_CXX20(string_char) T UTL_REQUIRES_CXX11(is_string_char<T>::value)>
UTL_LIBC_PURE UTL_HIDE_FROM_ABI constexpr T* strnset(
...
template <UTL_CONCEPT_CXX20(string_char) T UTL_REQUIRES_CXX11(is_string_char<T>::value)>
UTL_LIBC_PURE UTL_HIDE_FROM_ABI constexpr T* strnchr(
