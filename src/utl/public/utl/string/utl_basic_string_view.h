...
public:
    ...
    UTL_ATTRIBUTES(NODISCARD, PURE, ALWAYS_INLINE) UTL_HIDE_FROM_ABI constexpr const_pointer
    data() const noexcept {
        return data_;
    }
    UTL_ATTRIBUTES(NODISCARD, PURE, ALWAYS_INLINE) UTL_HIDE_FROM_ABI constexpr bool empty() const noexcept {
        return !size();
    }
    UTL_ATTRIBUTES(NODISCARD, PURE, ALWAYS_INLINE) UTL_HIDE_FROM_ABI constexpr size_type size() const noexcept {
        return size_;
    }
    UTL_ATTRIBUTES(NODISCARD, PURE, ALWAYS_INLINE) UTL_HIDE_FROM_ABI constexpr size_type
    ...
    UTL_ATTRIBUTES(NODISCARD, PURE, ALWAYS_INLINE) UTL_HIDE_FROM_ABI constexpr const_reference
    ...
    UTL_ATTRIBUTES(NODISCARD, PURE, ALWAYS_INLINE) UTL_HIDE_FROM_ABI constexpr const_reference operator[](
    ...
    UTL_STRING_PURE UTL_HIDE_FROM_ABI constexpr basic_string_view substr(
    ...
    UTL_STRING_PURE UTL_HIDE_FROM_ABI constexpr int compare(size_type pos, size_type count,
    ...
    UTL_STRING_PURE UTL_HIDE_FROM_ABI constexpr int compare(const_pointer other) const {
    ...
    UTL_STRING_PURE UTL_HIDE_FROM_ABI constexpr bool starts_with(
        basic_string_view other) const noexcept {
    ...
    UTL_STRING_PURE UTL_HIDE_FROM_ABI constexpr bool ends_with(
        basic_string_view other) const noexcept {
        return size() >= other.size() &&
    ...
    UTL_STRING_PURE UTL_HIDE_FROM_ABI constexpr bool ends_with(const_pointer other) const noexcept {
        // CONSTEXPR_ASSERT(other != nullptr);
        return ends_with(basic_string_view(other));
    }

    UTL_STRING_PURE UTL_HIDE_FROM_ABI constexpr bool contains(
        basic_string_view other) const noexcept {
    ...
    UTL_STRING_PURE UTL_HIDE_FROM_ABI constexpr bool contains(const_pointer other) const UTL_THROWS {
        return find(other) != npos;
    }
