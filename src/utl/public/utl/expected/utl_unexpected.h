...
namespace details {
template <typename T>
struct __UTL_PUBLIC_TEMPLATE is_unexpected_type : false_type {};
template <typename T>
struct __UTL_PUBLIC_TEMPLATE is_unexpected_type<T const> : is_unexpected_type<T> {};
template <typename T>
struct __UTL_PUBLIC_TEMPLATE is_unexpected_type<T volatile> : is_unexpected_type<T> {};
template <typename T>
struct __UTL_PUBLIC_TEMPLATE is_unexpected_type<unexpected<T>> : true_type {};
