...
constexpr __UTL tempus::duration operator""h(unsigned long long hour) noexcept {
...
constexpr __UTL tempus::duration operator""min(unsigned long long minutes) noexcept {
...
constexpr __UTL tempus::duration operator""s(unsigned long long seconds) noexcept {
    return __UTL tempus::duration{static_cast<int64_t>(seconds), 0};
}

constexpr __UTL tempus::duration operator""ms(unsigned long long milliseconds) noexcept {
...
constexpr __UTL tempus::duration operator""us(unsigned long long microseconds) noexcept {
...
constexpr __UTL tempus::duration operator""ns(unsigned long long nanoseconds) noexcept {
