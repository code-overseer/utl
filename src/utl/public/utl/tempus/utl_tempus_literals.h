...
__UTL_HIDE_FROM_ABI constexpr __UTL tempus::duration operator""h(unsigned long long hour) noexcept {
...
__UTL_HIDE_FROM_ABI constexpr __UTL tempus::duration operator""min(
...
__UTL_HIDE_FROM_ABI constexpr __UTL tempus::duration operator""s(
    unsigned long long seconds) noexcept {
    return __UTL tempus::duration{static_cast<int64_t>(seconds), 0};
}

__UTL_HIDE_FROM_ABI constexpr __UTL tempus::duration operator""ms(
...
__UTL_HIDE_FROM_ABI constexpr __UTL tempus::duration operator""us(
...
__UTL_HIDE_FROM_ABI constexpr __UTL tempus::duration operator""ns(
