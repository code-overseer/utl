...
#define __UTL_DEAGGREGATE_ATTRIBUTE_1(NAME) UTL_CONCAT(__UTL_ATTRIBUTE_, NAME)
#define __UTL_DEAGGREGATE_ATTRIBUTE_0(NAME) (NAME)
#define __UTL_DEAGGREGATE_ATTRIBUTE(NAME) \
    UTL_PASTE(UTL_APPEND_IS_EMPTY(        \
        __UTL_DEAGGREGATE_ATTRIBUTE_, UTL_CONCAT(__UTL_ATTRIBUTE_TYPE_AGGREGATE_, NAME))(NAME))

#define __UTL_ATTRIBUTE_DEAGGREGATION(ARGS) \
    UTL_SWAP_CONCAT(_END, __UTL_ATTRIBUTE_DEAGGREGATION_1 ARGS)
#if UTL_MSVC_PREPROCESSOR
#  define __UTL_ATTRIBUTE_DEAGGREGATION_1(NAME) \
      UTL_PASTE(__UTL_DEAGGREGATE_ATTRIBUTE(NAME) __UTL_ATTRIBUTE_DEAGGREGATION_2)
#  define __UTL_ATTRIBUTE_DEAGGREGATION_2(NAME) \
      UTL_PASTE(__UTL_DEAGGREGATE_ATTRIBUTE(NAME) __UTL_ATTRIBUTE_DEAGGREGATION_1)
#else
#  define __UTL_ATTRIBUTE_DEAGGREGATION_1(NAME) \
      __UTL_DEAGGREGATE_ATTRIBUTE(NAME) __UTL_ATTRIBUTE_DEAGGREGATION_2
#  define __UTL_ATTRIBUTE_DEAGGREGATION_2(NAME) \
      __UTL_DEAGGREGATE_ATTRIBUTE(NAME) __UTL_ATTRIBUTE_DEAGGREGATION_1
#endif
#define __UTL_ATTRIBUTE_DEAGGREGATION_1_END
#define __UTL_ATTRIBUTE_DEAGGREGATION_2_END

#define __UTL_ATTRIBUTES_0(LIST) \
    __UTL_CPP_ATTRIBUTES(LIST)   \
    __UTL_GNU_ATTRIBUTES(LIST) __UTL_DECLSPEC(LIST) __UTL_MSVC_EXT_ATTRIBUTES(LIST)

#define __UTL_ATTRIBUTES(LIST) __UTL_ATTRIBUTES_0(__UTL_ATTRIBUTE_DEAGGREGATION(LIST))
...
#define UTL_HAS_ATTRIBUTE(NAME) __UTL_HAS_ATTRIBUTE(__UTL_ATTRIBUTE_DEAGGREGATION((NAME)))
