...
#  define __UTL_FILTER_MSVC_EXTENSION_ATTRIBUTES(ARGS) \
      UTL_SWAP_CONCAT(_END, __UTL_FILTER_MSVC_EXTENSION_ATTRIBUTES_1 ARGS)
#  define __UTL_FILTER_MSVC_EXTENSION_ATTRIBUTES_1(NAME)                                   \
      __UTL_ATTRIBUTE_FILTER(NAME, UTL_CONCAT(__UTL_ATTRIBUTE_TYPE_MSVC_EXTENSION_, NAME)) \
      __UTL_FILTER_MSVC_EXTENSION_ATTRIBUTES_2
#  define __UTL_FILTER_MSVC_EXTENSION_ATTRIBUTES_2(NAME)                                   \
      __UTL_ATTRIBUTE_FILTER(NAME, UTL_CONCAT(__UTL_ATTRIBUTE_TYPE_MSVC_EXTENSION_, NAME)) \
      __UTL_FILTER_MSVC_EXTENSION_ATTRIBUTES_1
#  define __UTL_FILTER_MSVC_EXTENSION_ATTRIBUTES_1_END
#  define __UTL_FILTER_MSVC_EXTENSION_ATTRIBUTES_2_END
#  define __UTL_MSVC_EXTENSION_ATTRIBUTES(LIST) \
      UTL_PASTE(UTL_PASTE __UTL_TRANSLATE_ATTRIBUTE(__UTL_FILTER_MSVC_EXTENSIONS(LIST)))
#else
#  define __UTL_MSVC_EXTENSION_ATTRIBUTES(LIST)
#endif
...
#define __UTL_ATTRIBUTES(LIST) \
    ...
    __UTL_GNU_ATTRIBUTES(LIST) __UTL_DECLSPEC(LIST) __UTL_MSVC_EXTENSION_ATTRIBUTES(LIST)
