...
UTL_INLINE_CXX17 constexpr retain_object_t retain_object{};
UTL_INLINE_CXX17 constexpr adopt_object_t adopt_object{};
...
public:
     ...
     */
    __UTL_HIDE_FROM_ABI constexpr intrusive_ptr() noexcept : resource_(nullptr) {}
     ...
     * @throws utl::invalid_argument - if ptr is null and exceptions are enabled
     */
    __UTL_HIDE_FROM_ABI UTL_CONSTEXPR_CXX14 intrusive_ptr(adopt_object_t, T* ptr) UTL_THROWS
     ...
     * @throws utl::invalid_argument - if ptr is null and exceptions are enabled
     */
    __UTL_HIDE_FROM_ABI UTL_CONSTEXPR_CXX14 intrusive_ptr(retain_object_t, T* ptr) UTL_THROWS
     ...
     * Copy constructor
     */
    __UTL_HIDE_FROM_ABI UTL_CONSTEXPR_CXX14 intrusive_ptr(intrusive_ptr const& other) noexcept
     ...
     * Move constructor
     */
    __UTL_HIDE_FROM_ABI constexpr intrusive_ptr(intrusive_ptr&& other) noexcept
     ...
     * Destructor
     */
    __UTL_HIDE_FROM_ABI UTL_CONSTEXPR_CXX20 ~intrusive_ptr() noexcept { reset(); }

    /**
     * Dereference operator to access the object pointed to by the intrusive_ptr.
     */
    UTL_ATTRIBUTES(_HIDE_FROM_ABI, NODISCARD, PURE) constexpr T* operator->() const noexcept {
        return resource_;
    }
     ...
     */
    UTL_ATTRIBUTES(_HIDE_FROM_ABI, NODISCARD, PURE) constexpr T* get() const noexcept {
        return resource_;
    }
     ...
     */
    UTL_ATTRIBUTES(_HIDE_FROM_ABI, NODISCARD) UTL_CONSTEXPR_CXX14 T* release() noexcept {
     ...
     */
    UTL_ATTRIBUTES(_HIDE_FROM_ABI, NODISCARD, PURE) constexpr explicit operator bool() const noexcept {
     ...
     */
    UTL_ATTRIBUTES(_HIDE_FROM_ABI, REINITIALIZES) UTL_CONSTEXPR_CXX14 void reset() noexcept {
        if (resource_ != nullptr) {
            decrement(*resource_);
            resource_ = nullptr;
        }
     ...
     * @throws utl::invalid_argument - if ptr is null and exceptions are enabled
     */
    UTL_ATTRIBUTES(_HIDE_FROM_ABI, REINITIALIZES) UTL_CONSTEXPR_CXX14 void reset(retain_object_t, T* ptr)
        UTL_THROWS {
        reset();
     ...
     * @throws utl::invalid_argument - if ptr is null and exceptions are enabled
     */
    UTL_ATTRIBUTES(_HIDE_FROM_ABI, REINITIALIZES) UTL_CONSTEXPR_CXX14 void reset(adopt_object_t, T* ptr)
        UTL_THROWS {
        reset();
     ...
     */
    UTL_ATTRIBUTES(_HIDE_FROM_ABI, REINITIALIZES) UTL_CONSTEXPR_CXX14 void swap(intrusive_ptr& other) noexcept {
...
public:
     ...
     */
    UTL_ATTRIBUTES(_HIDE_FROM_ABI, NODISCARD, PURE) constexpr T const* operator->() const noexcept {
        return this->get();
    }
     ...
     */
    UTL_ATTRIBUTES(_HIDE_FROM_ABI, NODISCARD, PURE) constexpr T const* get() const noexcept {
     ...
     * Resets the `intrusive_ptr` to hold a null pointer and returns the previous raw pointer.
     */
    UTL_ATTRIBUTES(_HIDE_FROM_ABI, NODISCARD) UTL_CONSTEXPR_CXX14 T const* release() noexcept {
     ...
     * Copy constructor
     */
    __UTL_HIDE_FROM_ABI UTL_CONSTEXPR_CXX14 intrusive_ptr(intrusive_ptr<T const> const& other) noexcept
        : base_type(static_cast<base_type const&>(other)) {}

    /**
     * Copy assignment
     */
    __UTL_HIDE_FROM_ABI UTL_CONSTEXPR_CXX14 intrusive_ptr& operator=(
     ...
     * Move constructor
     */
    __UTL_HIDE_FROM_ABI constexpr intrusive_ptr(intrusive_ptr<T const>&& other) noexcept
     ...
     */
    __UTL_HIDE_FROM_ABI UTL_CONSTEXPR_CXX14 intrusive_ptr& operator=(
        intrusive_ptr<T const>&& other) noexcept {
...
__UTL_HIDE_FROM_ABI UTL_CONSTEXPR_CXX20 intrusive_ptr<T> make_intrusive_ptr(Args&&... args) {
