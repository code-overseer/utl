...
#  define UTL_TRAIT_is_predicate(...) __UTL predicate<__VA_ARGS__>
...
#    define UTL_TRAIT_is_predicate(...) __UTL is_boolean_testable_v<invoke_result_t<__VA_ARGS__>>

#  else

#    define UTL_TRAIT_is_predicate(...) \
        __UTL is_boolean_testable<invoke_result_t<__VA_ARGS__>>::value
