...
struct is_unambiguous_decendent_of : conjunction<
    is_complete<Derive>,
    is_base_of<Base, Derive>,
    type_trais::details::directly_castable<Base*, Derive*>
> {};

template<typename Derive, typename Base>
struct is_unambiguous_ancestor_of : conjunction<
    is_complete<Derive>,
    is_base_of<Base, Derive>,
...
template<typename T>
UTL_INLINE_CXX17 constexpr bool is_unambiguous_decendent_of_v = is_unambiguous_decendent_of<T>::value;
template<typename T>
