...
template <typename T>
struct UTL_PUBLIC_TEMPLATE is_member_function_pointer :
...
template <typename T>
struct UTL_PUBLIC_TEMPLATE is_member_function_pointer : false_type {};

template <typename T, typename U>
struct UTL_PUBLIC_TEMPLATE is_member_function_pointer<T U::*> : is_function<T> {};
