...
UTL_INLINE_CXX17 constexpr bool is_trivially_move_assignable_v =
    is_trivially_move_assignable<T, T&&>::value;
...
#  include "utl/type_traits/assignment_traits/utl_is_trivially_assignable.h"
...
template <typename T>
struct is_trivially_move_assignable : bool_constant<UTL_BUILTIN_is_trivially_assignable(T, T&&)> {};

#    ifdef UTL_CXX14
template <typename T>
UTL_INLINE_CXX17 constexpr bool is_trivially_move_assignable_v =
    UTL_BUILTIN_is_trivially_assignable(T, T&&);
#    endif // UTL_CXX14
...
#    ifdef UTL_CXX14
template <typename T>
UTL_INLINE_CXX17 constexpr bool is_trivially_move_assignable_v = is_trivially_assignable_v<T, T&&>;
#    endif // UTL_CXX14
