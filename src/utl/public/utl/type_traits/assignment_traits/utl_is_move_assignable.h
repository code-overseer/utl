...
template <typename T>
UTL_INLINE_CXX17 constexpr bool is_move_assignable_v = is_move_assignable<T, T&&>::value;
...
template <typename T>
struct is_move_assignable : bool_constant<UTL_BUILTIN_is_assignable(T, T&&)> {};

#    ifdef UTL_CXX14
template <typename T>
UTL_INLINE_CXX17 constexpr bool is_move_assignable_v = UTL_BUILTIN_is_assignable(T, T&&);
#    endif // UTL_CXX14
...
#    ifdef UTL_CXX14
template <typename T>
UTL_INLINE_CXX17 constexpr bool is_move_assignable_v = is_assignable_v<T, T&&>;
#    endif // UTL_CXX14
