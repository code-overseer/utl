...
template <typename T, typename U UTL_REQUIRES_CXX11(
    UTL_TRAIT_is_boolean_testable(strict_result_t<T, U>))>
auto strict_nothrow_check(int) noexcept
    -> UTL_SCOPE bool_constant<noexcept(static_cast<bool>(strict_result_t<T, U>))>;
template <typename T, typename U>
...
struct is_strict_subordinate_comparable_with :
    details::strict_subordinate_comparable::strict_impl_t<T, U> {};
template <typename T>
struct is_strict_subordinate_comparable :
    details::strict_subordinate_comparable::strict_impl_t<T, T> {};

template <typename T, typename U>
struct is_nothrow_strict_subordinate_comparable_with :
    details::strict_subordinate_comparable::strict_nothrow_t<T, U> {};
template <typename T>
struct is_nothrow_strict_subordinate_comparable :
    details::strict_subordinate_comparable::strict_nothrow_t<T, T> {};
...
UTL_INLINE_CXX17 constexpr bool is_strict_subordinate_comparable_v =
    is_strict_subordinate_comparable<T, U>::value;
template <typename T, typename U>
...
UTL_INLINE_CXX17 constexpr bool is_nothrow_strict_subordinate_comparable_v =
    is_nothrow_strict_subordinate_comparable<T, U>::value;
...
template <typename T>
UTL_INLINE_CXX17 constexpr bool is_subordinate_comparable_v = is_subordinate_comparable<T, U>::value;
template <typename T, typename U>
...
UTL_INLINE_CXX17 constexpr bool is_nothrow_subordinate_comparable_v =
    is_nothrow_subordinate_comparable<T, U>::value;
