...
__UTL_HIDE_FROM_ABI UTL_SCOPE true_type strict_impl(int) noexcept;
template <typename T, typename U>
__UTL_HIDE_FROM_ABI UTL_SCOPE false_type strict_impl(float) noexcept;
template <typename T, typename U UTL_REQUIRES_CXX11(
...
__UTL_HIDE_FROM_ABI UTL_SCOPE true_type strict_nothrow_check(int) noexcept;
template <typename T, typename U>
__UTL_HIDE_FROM_ABI UTL_SCOPE false_type strict_nothrow_check(float) noexcept;
