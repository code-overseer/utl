...
UTL_INLINE_CXX17 constexpr bool is_nothrow_copy_assignable_v =
    is_nothrow_copy_assignable<T, T const&>::value;
...
struct is_nothrow_copy_assignable :
    bool_constant<UTL_BUILTIN_is_nothrow_assignable(T, T const&)> {};

#    ifdef UTL_CXX14
template <typename T>
UTL_INLINE_CXX17 constexpr bool is_nothrow_copy_assignable_v =
    UTL_BUILTIN_is_nothrow_assignable(T, T const&);
#    endif // UTL_CXX14
...
template <typename T>
struct is_nothrow_copy_assignable : is_nothrow_assignable<T, T const&> {};

#    ifdef UTL_CXX14
template <typename T>
UTL_INLINE_CXX17 constexpr bool is_nothrow_copy_assignable_v = is_nothrow_assignable_v<T, T const&>;
#    endif // UTL_CXX14
