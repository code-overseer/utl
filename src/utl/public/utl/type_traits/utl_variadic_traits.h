...
struct __UTL_PUBLIC_TEMPLATE variadic_traits {
    ...
    static constexpr bool is_nothrow_swappable =
        conjunction<UTL_SCOPE is_nothrow_swappable<Types>...>::value;
    static constexpr bool is_nothrow_const_swappable =
        conjunction<UTL_SCOPE is_nothrow_swappable<add_const_t<Types>>...>::value;
    static constexpr bool is_nothrow_default_constructible =
        conjunction<UTL_SCOPE is_nothrow_default_constructible<Types>...>::value;
    static constexpr bool is_nothrow_copy_constructible =
        conjunction<UTL_SCOPE is_nothrow_copy_constructible<Types>...>::value;
    static constexpr bool is_nothrow_copy_assignable =
        conjunction<UTL_SCOPE is_nothrow_copy_assignable<Types>...>::value;
    static constexpr bool is_nothrow_const_copy_assignable =
        conjunction<UTL_SCOPE is_nothrow_copy_assignable<add_const_t<Types>>...>::value;
    static constexpr bool is_nothrow_const_move_assignable =
        conjunction<UTL_SCOPE is_nothrow_assignable<add_lvalue_reference_t<add_const_t<Types>>,
            add_rvalue_reference_t<Types>>...>::value;
    static constexpr bool is_nothrow_move_constructible =
        conjunction<UTL_SCOPE is_nothrow_move_constructible<Types>...>::value;
    static constexpr bool is_nothrow_move_assignable =
        conjunction<UTL_SCOPE is_nothrow_move_assignable<Types>...>::value;
    static constexpr bool is_implicit_default_constructible =
        conjunction<UTL_SCOPE is_implicit_constructible<Types>...>::value;
    static constexpr bool is_explicit_default_constructible =
        disjunction<UTL_SCOPE is_explicit_constructible<Types>...>::value;
    static constexpr bool is_copy_constructible =
        conjunction<UTL_SCOPE is_copy_constructible<Types>...>::value;
    static constexpr bool is_move_constructible =
        conjunction<UTL_SCOPE is_move_constructible<Types>...>::value;
    static constexpr bool is_copy_assignable =
        conjunction<UTL_SCOPE is_copy_assignable<Types>...>::value;
    static constexpr bool is_const_copy_assignable =
        conjunction<UTL_SCOPE is_copy_assignable<add_const_t<Types>>...>::value;
    static constexpr bool is_move_assignable =
        conjunction<UTL_SCOPE is_move_assignable<Types>...>::value;
    static constexpr bool is_const_move_assignable =
        conjunction<UTL_SCOPE is_move_assignable<add_const_t<Types>>...>::value;
    ...
    struct __UTL_PUBLIC_TEMPLATE matches : conjunction<UTL_SCOPE is_same<Types, UTypes>...> {};
    ...
    static auto is_explicit_constructible_impl() noexcept
        -> disjunction<UTL_SCOPE is_explicit_constructible<Types, UTypes>...>;
    template <typename... UTypes>
