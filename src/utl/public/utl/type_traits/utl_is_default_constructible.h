...
UTL_INLINE_CXX17 constexpr bool is_default_constructible_v =
    is_default_constructible<T, Args...>::value;
...
template <typename T>
struct is_default_constructible : bool_constant<UTL_BUILTIN_is_constructible(T)> {};
