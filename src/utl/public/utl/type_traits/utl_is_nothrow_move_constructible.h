...
template <typename T>
UTL_INLINE_CXX17 constexpr bool is_nothrow_move_constructible_v = is_nothrow_move_constructible<T>::value;
...
template <typename T>
struct __UTL_PUBLIC_TEMPLATE is_nothrow_move_constructible :
...
#if UTL_CXX14
#  define UTL_TRAIT_is_nothrow_move_constructible(TYPE) __UTL is_nothrow_move_constructible_v<TYPE>
#else
#  define UTL_TRAIT_is_nothrow_move_constructible(TYPE) \
      __UTL is_nothrow_move_constructible<TYPE>::value
#endif
