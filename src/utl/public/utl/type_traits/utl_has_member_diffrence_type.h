...
UTL_NAMESPACE_BEGIN
template <typename T>
struct has_member_difference_type : false_type {};

template <typename T>
requires requires { typename T::difference_type; }
struct has_member_difference_type<T> : true_type {};
...
struct has_member_difference_type_impl : false_type {};

template <typename T>
struct has_member_difference_type_impl<T, void_t<typename T::difference_type>> : true_type {};
} // namespace details
} // namespace type_traits
