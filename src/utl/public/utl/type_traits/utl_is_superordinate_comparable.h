...
struct is_strict_superordinate_comparable_with :
    details::strict_superordinate_comparable::strict_impl_t<T, U> {};
template <typename T>
struct is_strict_superordinate_comparable :
    details::strict_superordinate_comparable::strict_impl_t<T, T> {};

template <typename T, typename U>
struct is_nothrow_strict_superordinate_comparable_with :
    details::strict_superordinate_comparable::strict_nothrow_t<T, U> {};
template <typename T>
struct is_nothrow_strict_superordinate_comparable :
    details::strict_superordinate_comparable::strict_nothrow_t<T, T> {};
...
UTL_INLINE_CXX17 constexpr bool is_strict_superordinate_comparable_v =
    is_strict_superordinate_comparable<T, U>::value;
template <typename T, typename U>
...
UTL_INLINE_CXX17 constexpr bool is_nothrow_strict_superordinate_comparable_v =
    is_nothrow_strict_superordinate_comparable<T, U>::value;
...
template <typename T>
UTL_INLINE_CXX17 constexpr bool is_superordinate_comparable_v = is_superordinate_comparable<T, U>::value;
template <typename T, typename U>
...
UTL_INLINE_CXX17 constexpr bool is_nothrow_superordinate_comparable_v =
    is_nothrow_superordinate_comparable<T, U>::value;
