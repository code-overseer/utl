...
UTL_NAMESPACE_BEGIN
template <typename T>
struct has_member_reference : false_type {};

template <typename T>
requires requires { typename T::reference; }
struct has_member_reference<T> : true_type {};
...
struct has_member_reference_impl : false_type {};

template <typename T>
struct has_member_reference_impl<T, void_t<typename T::reference>> : true_type {};
} // namespace details
} // namespace type_traits
