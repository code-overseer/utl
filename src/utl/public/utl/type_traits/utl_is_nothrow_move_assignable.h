...
template <typename T>
UTL_INLINE_CXX17 constexpr bool is_nothrow_move_assignable_v = is_nothrow_move_assignable<T>::value;
...
template <typename T>
struct __UTL_PUBLIC_TEMPLATE is_nothrow_move_assignable :
...
UTL_INLINE_CXX17 constexpr bool is_nothrow_move_assignable_v =
    UTL_BUILTIN_is_nothrow_assignable(add_lvalue_reference_t<T>, add_rvalue_reference_t<T>);
#    endif // UTL_CXX14
