...
UTL_ATTRIBUTES(NODISCARD, CONST, ALWAYS_INLINE, _HIDE_FROM_ABI) constexpr 
UTL_ENABLE_IF_CXX11(underlying_type_t<T>, UTL_TRAIT_is_enum(T)) to_underlying(T value) noexcept {
