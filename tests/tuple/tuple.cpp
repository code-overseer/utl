...
template<int N>
struct utl::uses_allocator<tuple_test::copy_only<N>, tuple_test::alloc> : std::true_type {};
...
struct not_gettable_by_type<T, Tuple, utl::void_t<decltype(utl::get<T>(utl::declval<utl::remove_cvref_t<Tuple>>()))>> : utl::false_type {};
static_assert(not_gettable_by_type<short, decltype(t)>::value, "Should not be gettable by type if type does not exist");
...
static_assert(utl::is_same<decltype(tuple_cat(t1, t2)), utl::tuple<int, float, long long, double>>::value,
...
static_assert(not_gettable_by_type<short, decltype(w)>::value, "Should not be gettable by type if target is not unique");

template<int>
struct f {};
static_assert(utl::is_same<decltype(utl::forward_as_tuple(f<0>{}, f<1>{}, f<2>{})),
    utl::tuple<f<0>&&,f<1>&&, f<2>&&>>::value, "utl::forward_as_tuple must be lvalue if lvalue, rvalue otherwise");

static_assert(utl::is_same<decltype(utl::forward_as_tuple(utl::declval<f<0>&>(), f<1>{}, f<2>{})),
    utl::tuple<f<0>&,f<1>&&, f<2>&&>>::value, "utl::forward_as_tuple must be lvalue if lvalue, rvalue otherwise");

static_assert(utl::is_same<decltype(utl::forward_as_tuple(utl::declval<f<0> const&>(), utl::declval<f<0>&>(), utl::declval<f<0> const volatile&>())),
    utl::tuple<f<0> const&,f<0>&, f<0> const volatile&>>::value, "utl::forward_as_tuple must conserve cv qualifiers");
...
static_assert(!utl::is_copy_constructible<move_only<0>>::value,
    "move_only should be copy constructible");
static_assert(!utl::is_copy_assignable<move_only<0>>::value,
    "move_only should be copy assignable");
static_assert(utl::is_move_constructible<move_only<0>>::value,
    "move_only should be move constructible");
static_assert(utl::is_move_assignable<move_only<0>>::value,
...
public:
    ...
    explicit constexpr copy_only(copy_only const&, const alloc&);


    constexpr copy_only(copy_only&&) noexcept = delete;
    UTL_CONSTEXPR_CXX14 copy_only& operator=(copy_only&&) noexcept = delete;  
    explicit constexpr copy_only(copy_only&&, const alloc&) = delete;
};

static_assert(utl::is_copy_constructible<copy_only<0>>::value,
    "copy_only should be copy constructible");
static_assert(utl::is_copy_assignable<copy_only<0>>::value,
    "copy_only should be copy assignable");
static_assert(!utl::is_move_constructible<copy_only<0>>::value,
    "copy_only should be move constructible");
static_assert(!utl::is_move_assignable<copy_only<0>>::value,
...
static_assert(!utl::is_constructible<utl::tuple<move_only<0>, move_only<1>>, utl::tuple<move_only<0>&&,move_only<1>&&>const &>::value,
    "Move only tuple should not be constructible with an lvalue tuple of rvalue references of the same element types");
static_assert(utl::is_constructible<utl::tuple<move_only<0>, move_only<1>>, utl::tuple<move_only<0>&&,move_only<1>&&>>::value,
    "Move only tuple should be constructible with an rvalue tuple of rvalue references of the same element types");

static_assert(utl::is_constructible<utl::tuple<copy_only<0>,copy_only<1>>, utl::tuple<copy_only<0>&&,copy_only<1>&&> const&>::value,
    "Copy only tuple should be constructible with an lvalue tuple of rvalue references of the same element types");

static_assert(!utl::is_assignable<utl::tuple<copy_only<0>,copy_only<1>>&, utl::tuple<copy_only<0>&&,copy_only<1>&&>>::value,
    "Copy only tuple should not be assignable with an rvalue tuple of rvalue references of the same element types");
...
static_assert(!utl::is_constructible<utl::tuple<copy_only<0>,copy_only<1>>, 
    ...
    "Copy only tuple should not be constructible with an rvalue tuple of rvalue references of the same element types");
...
static_assert(!utl::is_constructible<utl::tuple<copy_only<0>,copy_only<1>>, utl::tuple<copy_only<0>&&,copy_only<1>&&>>::value,
    "Copy only tuple should not be constructible with an rvalue tuple of rvalue references of the same element types");
...
static_assert(utl::is_constructible<utl::tuple<copy_only<0>,copy_only<1>>, 
    ...
    alloc,
    utl::tuple<copy_only<0>&&,copy_only<1>&&>>::value,
    "Copy only tuple should be constructible with an rvalue tuple of rvalue references of the same element types");
...
static_assert(utl::is_constructible<utl::tuple<int, defaultable<0>, float>, int, defaultable<0>, float>::value,
    "If all element are default constructible, tuple is default constructible");

static_assert(utl::is_nothrow_default_constructible<utl::tuple<defaultable<0>, defaultable<1>, defaultable<3>>>::value,
    "If all element are nothrow constructible, tuple is nothrow constructible");

static_assert(utl::is_nothrow_constructible<utl::tuple<long long, double>, utl::tuple<int, float>>::value,
    "If all element are nothrow constructible, tuple is nothrow constructible");
...
static_assert(utl::is_nothrow_constructible<
    utl::tuple<defaultable<0>, defaultable<1>, defaultable<3>>,
...
// constexpr utl::tuple<defaultable<0>, defaultable<1>, defaultable<3>> asdas(defaultable<0>{}, defaultable<1>{}, defaultable<3>{});
// constexpr utl::tuple<defaultable<0>, defaultable<1>, defaultable<3>> jkadsmjsamd(defaultable<2>{}, defaultable<3>{}, defaultable<1>{});
    

static_assert(utl::is_nothrow_copy_constructible<utl::tuple<defaultable<0>, defaultable<1>, defaultable<3>>>::value,
    "If all element are nothrow constructible, tuple is nothrow constructible");

static_assert(utl::is_nothrow_move_constructible<utl::tuple<defaultable<0>, defaultable<1>, defaultable<3>>>::value,
    "If all element are nothrow constructible, tuple is nothrow constructible");

static_assert(utl::is_nothrow_copy_assignable<utl::tuple<defaultable<0>, defaultable<1>, defaultable<3>>>::value,
    "If all element are nothrow assignable, tuple is nothrow assignable");

static_assert(utl::is_nothrow_move_assignable<utl::tuple<defaultable<0>, defaultable<1>, defaultable<3>>>::value,
    "If all element are nothrow assignable, tuple is nothrow assignable");
