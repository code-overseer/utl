...
constexpr bool always_false(A&&...) noexcept { return false; }
template<typename... A>
UTL_ATTRIBUTES(NODISCARD, CONST)
constexpr bool always_true(A&&...) noexcept { return true; }
}   // namespace exception
}   // namespace details
...
#define UTL_THROW(...) ASSERT(UTL_SCOPE details::exception::always_false(__VA_ARGS__)); UTL_BUILTIN_unreachable()
#define UTL_RETHROW ASSERT(false); UTL_BUILTIN_unreachable()
