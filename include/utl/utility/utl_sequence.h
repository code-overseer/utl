...
UTL_PRAGMA_WARN("The current standard does not implement integer_sequence, `UTL_USE_STD_sequence_utility` ignored")
...
template<typename T, size_t N>
struct generate : combine<typename generate<T, N/2>::type, typename generate<T, N - N/2>::type> {};
...
#endif  // defined(UTL_CXX14) && defined(UTL_USE_STD_sequence_utility) && UTL_USE_STD_sequence_utility
