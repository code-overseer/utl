...
UTL_PRAGMA_WARN("The current standard does not implement to_underlying, `UTL_USE_STD_to_underlying` ignored")
...
constexpr enable_if_t<is_enum<Enum>::value, underlying_type_t<Enum>> to_underlying(Enum value) noexcept {
