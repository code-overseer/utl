...
template<typename T>
struct remove_reference { using type = UTL_BUILTIN_remove_reference(T); };
...
template<typename T>
struct add_lvalue_reference { using type = UTL_BUILTIN_add_lvalue_reference(T); };
...
template<typename T>
struct add_rvalue_reference { using type = UTL_BUILTIN_add_rvalue_reference(T); };
