 ...
 *
 * @result typename type - const-qualified Target iff there is a const-qualified type in the type list
 */
template<typename Target, typename TypeList>
struct merge_const;
template<typename Target, template<typename...> class TypeList>
struct merge_const<Target, TypeList<>> { using type = Target; };
template<typename Target, template<typename...> class TypeList, typename U0, typename... Us>
struct merge_const<Target, TypeList<U0 const, Us...>> { using type = Target const; };
template<typename Target, template<typename...> class TypeList, typename U0, typename... Us>
 ...
 * @tparam TypeList - type list to merge/unionize
 *
 * @result typename type - volatile-qualified Target iff there is a volatile-qualified type in the type list
 */
template<typename Target, typename TypeList>
struct merge_volatile;
template<typename Target, template<typename...> class TypeList>
struct merge_volatile<Target, TypeList<>> { using type = Target; };
template<typename Target, template<typename...> class TypeList, typename U0, typename... Us>
struct merge_volatile<Target, TypeList<U0 volatile, Us...>> { using type = Target volatile; };
template<typename Target, template<typename...> class TypeList, typename U0, typename... Us>
 ...
 * @tparam TypeList - type list to merge/unionize
 *
 * @result typename type - cv-qualified Target depending on the const/volatile-ness of the elements in the typelist
 */
template<typename Target, typename TypeList>
struct merge_cv;
template<typename Target, template<typename...> class TypeList>
struct merge_cv<Target, TypeList<>> { using type = Target; };
template<typename Target, template<typename...> class TypeList, typename U0, typename... Us>
struct merge_cv<Target, TypeList<U0 const volatile, Us...>> { using type = Target const volatile; };
template<typename Target, template<typename...> class TypeList, typename U0, typename... Us>
struct merge_cv<Target, TypeList<U0 const, Us...>> : merge_volatile<Target const, type_list<Us...>> {};
template<typename Target, template<typename...> class TypeList, typename U0, typename... Us>
struct merge_cv<Target, TypeList<U0 volatile, Us...>> : merge_const<Target volatile, type_list<Us...>> {};
template<typename Target, template<typename...> class TypeList, typename U0, typename... Us>
