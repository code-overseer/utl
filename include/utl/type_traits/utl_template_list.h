...
struct template_count<T, List<T, Args...>> : integral_constant<size_t, 1 + template_count<T, type_list<Args...>>::value> {};

template<typename T, typename U, template<typename...> class List, typename... Args>
struct template_count<T, List<U, Args...>> : integral_constant<size_t, template_count<T, type_list<Args...>>::value> {};
...
struct template_index<T, TList<Head, Tail...>> : integral_constant<size_t, 1 + template_index<T, TList<Tail...>>::value> {};


template<typename T, typename U>
struct template_concat;
template<template<typename...> class List, typename... Ts, typename... Us>
struct template_concat<List<Ts...>, List<Us...>> { using type = List<Ts..., Us...>; };
template<typename T, typename U>
...
struct template_count<value_constant<T, Value>, List<Value, Tail...>> : integral_constant<size_t, 1 + template_count<value_constant<T, Value>, auto_list<Tail...>>::value> {};
