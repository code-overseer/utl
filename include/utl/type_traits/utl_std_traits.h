...
auto nothrow_test(int) -> enable_if_t<is_convertible<From,To>::value, bool_constant<noexcept(static_cast<To>(declval<From>()))>>;
...
template<typename T, typename U>
struct is_pointer_interconvertible_base_of : bool_constant<UTL_BUILTIN_is_pointer_interconvertible_base_of(T, U)> {};

#ifdef UTL_CXX14
template<typename T, typename U>
UTL_INLINE_CXX17 constexpr bool is_pointer_interconvertible_base_of_v = UTL_BUILTIN_is_pointer_interconvertible_base_of(T,U);
#endif
...
#ifdef UTL_CXX14
template<typename T, typename U>
UTL_INLINE_CXX17 constexpr bool is_pointer_interconvertible_base_of_v = is_pointer_interconvertible_base_of<T,U>::value;
#endif
...
template<typename T, typename U>
struct reference_constructs_from_temporary : bool_constant<UTL_BUILTIN_reference_constructs_from_temporary(T, U)> {};
#define UTL_TRAIT_SUPPORTED_reference_constructs_from_temporary 1

#ifdef UTL_CXX14
template<typename T, typename U>
UTL_INLINE_CXX17 constexpr bool reference_constructs_from_temporary_v = UTL_BUILTIN_reference_constructs_from_temporary(T,U);
#endif
...
#ifdef UTL_CXX14
template<typename T, typename U>
UTL_INLINE_CXX17 constexpr bool reference_constructs_from_temporary_v = reference_constructs_from_temporary<T,U>::value;
#endif
