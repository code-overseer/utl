...
#define UTL_SHOULD_USE_BUILTIN(BUILTIN) (UTL_HAS_BUILTIN(__##BUILTIN) || UTL_IS_RESERVED_IDENTIFIER(__##BUILTIN)) && !UTL_DISABLE_BUILTIN_##BUILTIN
...
#if UTL_HAS_BUILTIN(__is_layout_compatible) || UTL_COMPILER_GCC_AT_LEAST(12,0,0) || UTL_COMPILER_MSVC_AT_LEAST(1929)
#define UTL_BUILTIN_is_layout_compatible(...) __is_layout_compatible(__VA_ARGS__)
#endif

#if UTL_HAS_BUILTIN(__is_pointer_interconvertible_base_of) || UTL_COMPILER_GCC_AT_LEAST(12,0,0) || UTL_COMPILER_MSVC_AT_LEAST(1929)
#define UTL_BUILTIN_is_pointer_interconvertible_base_of(...) __is_pointer_interconvertible_base_of(__VA_ARGS__)
#endif

#if UTL_HAS_BUILTIN(__reference_constructs_from_temporary) || UTL_COMPILER_GCC_AT_LEAST(13,0,0)
#define UTL_BUILTIN_is_pointer_interconvertible_base_of(...) __reference_constructs_from_temporary(__VA_ARGS__)
#endif
