...
/** TODO: This is way too complicated and probably adds some preprocessing overhead, investigate if there is a simpler way  **/

#define UTL_AL_SCOPE_IF_1()
#define UTL_AL_SCOPE_IF_0(...) [[__VA_ARGS__]]
#define UTL_AL_SCOPE_IF(...) UTL_PASTE(UTL_APPEND_IS_EMPTY(UTL_AL_SCOPE_IF_, __VA_ARGS__) (__VA_ARGS__))
...
#define UTL_AL_BUILD_LIST_IMPL_1(MEMBER) UTL_AL_BUILD_LIST_IMPL_BEGIN(MEMBER) UTL_AL_BUILD_LIST_IMPL_2
...
#define UTL_AL_APPLY_NONSTD_IMPL_1(NAME) UTL_AL_NONSTD(NAME, UTL_AL_NONSTD_DEFINITION(NAME)) UTL_AL_APPLY_NONSTD_IMPL_2
#define UTL_AL_APPLY_NONSTD_IMPL_2(NAME) UTL_AL_NONSTD(NAME, UTL_AL_NONSTD_DEFINITION(NAME)) UTL_AL_APPLY_NONSTD_IMPL_1
#define UTL_AL_APPLY_NONSTD_IMPL_1_END
#define UTL_AL_APPLY_NONSTD_IMPL_2_END

#define UTL_AL_PARENTHESIZE(_0) (_0)

#define UTL_ATTRIBUTES_(ATTR) UTL_AL_APPLY_NONSTD(ATTR) UTL_AL_SCOPE_IF(UTL_AL_BUILD_LIST(UTL_AL_CLEAN_ARGS(UTL_AL_EXPAND(ATTR))))

#define UTL_ATTRIBUTES(...) UTL_ATTRIBUTES_(UTL_PASTE(UTL_APPLY_MACRO(UTL_AL_PARENTHESIZE, __VA_ARGS__)))
#define UTL_ATTRIBUTE(ATTR) UTL_AL_APPLY_NONSTD((ATTR)) UTL_AL_SCOPE_IF(UTL_CONCAT(UTL_ATTRIBUTE_, ATTR))
