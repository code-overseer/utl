...
public:
    ...
    constexpr strong_ordering(T p) noexcept : value(
        p == T::less ? less :
    ...
    friend constexpr bool operator==(strong_ordering l, strong_ordering r) noexcept { return l.value == r.value; }
    UTL_ATTRIBUTES(NODISCARD, CONST)
    friend constexpr bool operator==(strong_ordering l, zero_t) noexcept { return l.value == 0; }

#define UTL_ORDERING_COMPARISONS(SYMBOL) \
    UTL_ATTRIBUTES(NODISCARD, CONST) \
    friend constexpr bool operator SYMBOL (zero_t, strong_ordering r) noexcept { return 0 SYMBOL r.value; } \
    friend constexpr bool operator SYMBOL (strong_ordering l, zero_t) noexcept { return l.value SYMBOL 0; }
...
#ifdef UTL_CXX20
    UTL_ATTRIBUTES(NODISCARD, CONST)
    friend constexpr strong_ordering operator<=>(strong_ordering l, zero_t) noexcept {
        return l;
    }
...
UTL_INLINE_CXX17 constexpr strong_ordering strong_ordering::less{compare::details::order_t::less};
UTL_INLINE_CXX17 constexpr strong_ordering strong_ordering::equivalent{compare::details::order_t::equal};
UTL_INLINE_CXX17 constexpr strong_ordering strong_ordering::equal{compare::details::order_t::equal};
UTL_INLINE_CXX17 constexpr strong_ordering strong_ordering::greater{compare::details::order_t::greater};
