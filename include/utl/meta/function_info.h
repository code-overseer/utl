...
struct function_traits : function_type<F> {
    ...
    static_assert(is_same<F, type>::value, "Function pointers and references are not allowed as a template parameter");
...
struct template_element<I, function_traits<F>> : template_element<I, functional::argument_list_t<F>> {};
template<size_t I, typename F>
...
namespace std {
template<typename F>
struct tuple_size<UTL_SCOPE function_type<F>> : UTL_SCOPE template_size<UTL_SCOPE function_type<F>> {};
template<typename F>
struct tuple_size<UTL_SCOPE function_traits<F>> : UTL_SCOPE template_size<UTL_SCOPE function_traits<F>> {};
template<size_t I, typename F>
struct tuple_element<I, UTL_SCOPE function_type<F>> : UTL_SCOPE template_element<I, UTL_SCOPE function_type<F>> {};
template<size_t I, typename F>
struct tuple_element<I, UTL_SCOPE function_traits<F>> : UTL_SCOPE template_element<I, UTL_SCOPE function_traits<F>> {};
}
